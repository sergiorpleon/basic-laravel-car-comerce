...
@section('content')
    <div class="container text-center">
        <h1>
            <i class="fa fa-shopping-cart"></i>USUARIOS <small>Crear usuarios</small>
        </h1>
    </div>
    <div class="row justify-content-center">
        <div class="col-md-offset-3 col-md-6">
            <div class="page">
                ...
                <div class="form-group"><label for="extract">Contraseña:</label>
                    {!! Form::password(
                        'password',
                        null,
                        array(
                ...
                <div class="form-group"><label for="password-confirm">Confirmar Contraseña:</label>
                    {!! Form::password(
                        'password-confirm',
                        null,
                        array(
